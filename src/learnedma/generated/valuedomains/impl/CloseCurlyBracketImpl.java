...
/**
 * The implementation of CloseCurlyBracket
 */
public class CloseCurlyBracketImpl extends CloseCurlyBracket implements IValueInstance
{
     ...
     */
    public CloseCurlyBracketImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this CloseCurlyBracket to another CloseCurlyBracket
     * @param closeCurlyBracket  The CloseCurlyBracket to compare with
     * @return                   A negative integer, zero, or a positive
     *                           integer as this CloseCurlyBracket is less than,
     *                           equal to, or greater than the specified
     *                           CloseCurlyBracket
     */
    public int compareTo(CloseCurlyBracket closeCurlyBracket)
    {
        return edma_domain.valueCompare(value, ((CloseCurlyBracketImpl) closeCurlyBracket).value);
    }
