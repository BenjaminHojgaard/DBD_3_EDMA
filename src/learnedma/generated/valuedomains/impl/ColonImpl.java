...
/**
 * The implementation of Colon
 */
public class ColonImpl extends Colon implements IValueInstance
{
    ...
    /**
     * Compare this Colon to another Colon
     * @param colon  The Colon to compare with
     * @return       A negative integer, zero, or a positive integer as this
     *               Colon is less than, equal to, or greater than the specified
     *               Colon
     */
    public int compareTo(Colon colon)
    {
        return edma_domain.valueCompare(value, ((ColonImpl) colon).value);
    }
